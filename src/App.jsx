...
function App() {
  ...
  // Indicador: cantidad de categorías diferentes
  const categoriasUnicas = new Set(
    contactos
      .map((c) => (c.etiqueta || "").trim().toLowerCase())
      .filter((etiqueta) => etiqueta !== "")
  );

  const cantidadCategorias = categoriasUnicas.size;
          ...
          <aside className="space-y-4 md:space-y-5">
            ...
            <div className="rounded-3xl bg-gradient-to-br from-purple-600 to-purple-800 text-white p-6 shadow-xl flex flex-col justify-between min-h-[220px]">
              ...
              <div className="mt-6 space-y-3 text-sm">
                ...
                <p className="text-[11px] text-purple-100/80">
                  Indicador basado en las etiquetas utilizadas en los
                  contactos.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-slate-900 border border-slate-700 p-4 text-slate-100 shadow-sm">
              ...
              <p className="text-xs text-slate-400 mt-3">
                “Busco seguir aprendiendo y mejorando mis habilidades para
                desarrollar aplicaciones eficientes, innovadoras y capaces de
